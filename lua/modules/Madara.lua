...
function Init()
  ...
  AddWebsiteModule('MangaRead', 'https://www.mangaread.org', cat)

  cat = 'English-Scanlation'
  AddWebsiteModule('TrashScanlations', 'https://trashscanlations.com', cat)
  AddWebsiteModule('ChibiManga', 'https://www.cmreader.info', cat)
  ...
  AddWebsiteModule('TwilightScans', 'https://twilightscans.com', cat)
  ...
  AddWebsiteModule('TraduccionesAmistosas', 'https://nartag.com/', cat)
  ...
  AddWebsiteModule('ToonilyNet', 'https://toonily.net', cat)
  ...
  AddWebsiteModule('ManhuasWorld', 'https://www.manhuasworld.com', cat)
  AddWebsiteModule('MangaNeloLink', 'https://manganelo.link', cat)
